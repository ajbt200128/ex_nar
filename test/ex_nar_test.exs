defmodule ExNarTest do
  ...
  test "deserialize regular" do
    ...
    ExNar.deserialize!("test/foo.nar", @output_path <> "/foo")
    ...
    ExNar.deserialize!("test/executable.nar", @output_path <> "/executable")
  ...
  test "deserialize symlink" do
    ExNar.deserialize!("test/foobar_ln.nar", @output_path <> "/foobar_ln")
  ...
  test "deserialize identity" do
    ...
    ExNar.deserialize!("test/expected.nar", @output_path <> "/expected")
